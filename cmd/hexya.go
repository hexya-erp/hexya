...
func init() {
	...
	HexyaCmd.PersistentFlags().String("db-ssl-mode", "disable", "SSL mode to connect to the database. Must be one of 'disable' (default), 'require', 'verify-ca' or 'verify-full'")
