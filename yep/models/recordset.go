...
//*/
//func (rs RecordSet) Write(data orm.Params) bool {
...
//*/
//func (rs RecordSet) Filter(cond string, data ...interface{}) RecordSet {
...
//*/
//func (rs RecordSet) Exclude(cond string, data ...interface{}) RecordSet {
//	newRs := copyRecordStruct(rs)
...
//*/
//func (rs RecordSet) SetCond(cond *orm.Condition) RecordSet {
//	newRs := copyRecordStruct(rs)
...
//*/
//func (rs RecordSet) Limit(limit interface{}, args ...interface{}) RecordSet {
//	newRs := copyRecordStruct(rs)
...
//*/
//func (rs RecordSet) Offset(offset interface{}) RecordSet {
//	newRs := copyRecordStruct(rs)
...
//*/
//func (rs RecordSet) RelatedSel(params ...interface{}) RecordSet {
//	newRs := copyRecordStruct(rs)
...
//It panics in case of error
//*/
//func (rs RecordSet) SearchCount() int64 {
//	num, err := rs.qs.Count()
//	if err != nil {
...
//		}
//		rs = rs.Search().(RecordSet)
//		for i, item := range rs.Records() {
//			item.(RecordSet).computeFields(contSlice[i])
//		}
//		return num
//	}
...
//*/
//func (rs RecordSet) Values(results *[]orm.Params, exprs ...string) int64 {
...
//		rec.(RecordSet).computeFieldValues(&(*results)[i], exprs...)
//	}
//	return num
//}
//
...
//*/
//func (rs RecordSet) ValuesFlat(result *orm.ParamsList, expr string) int64 {
...
//			rec.(RecordSet).computeFieldValues(&params, expr)
...
//*/
//func (rs RecordSet) computeFieldValues(params *orm.Params, fields ...string) {
