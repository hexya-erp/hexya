...
// It is meant to be called from a Po updater start file (generated by hexya i18n update)
// which imports all the project's module.
func UpdatePOFiles(config map[string]any) {
