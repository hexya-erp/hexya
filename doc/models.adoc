...
A contexted field must be stored, must not be a relation field, must not be a
related field and must not be unique. It may have up to 4 different contexts.
